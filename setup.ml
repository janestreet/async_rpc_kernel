(* OASIS_START *)
(* DO NOT EDIT (digest: 7c38d48b09e1e9fa08bf1a9630cc5277) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_rpc_kernel";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("comparelib", None);
                           FindlibPackage ("comparelib.syntax", None);
                           FindlibPackage ("core_kernel", None);
                           FindlibPackage ("custom_printf", None);
                           FindlibPackage ("custom_printf.syntax", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "async_rpc_kernel";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\1502\160b=\196\012\181u\030\1762\247\"R\031";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
