...
module Message : sig
  ...
  val bin_read_t__local : ('a, 'a t) Bin_prot.Read.reader1__local @@ portable
  val bin_read_nat0_t__local : Nat0.t t Bin_prot.Read.reader__local @@ portable
end

module Stream_query : sig @@ portable
...
module Stream_initial_message : sig @@ portable
...
module Stream_response_data : sig @@ portable
