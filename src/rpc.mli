...
module Rpc : sig
  ...
  module Expert : sig
    ...
    (** [dispatch_bin_prot_with_metadata'] is the same as the non-expert {!dispatch'},
        except with metadata. It allows specifying the {!Rpc_metadata.V2.t} sent alongside
        this query.

        The [metadata] is merged with the metadata generated by the hooks from
        {!Connection.set_metadata_hooks}, where the metadata hooks take priority *)
    val dispatch_bin_prot_with_metadata'
      :  ('query, 'response) t
      -> Connection.t
      -> 'query
...
module Pipe_rpc : sig
  ...
  module Expert : sig
    ...
    (** [dispatch_iter_bin_prot_with_metadata] is the same as the non-expert
        {!dispatch_iter}, except with metadata. It allows specifying the
        {!Rpc_metadata.V2.t} sent alongside this query.

        The [metadata] is merged with the metadata generated by the hooks from
        {!Connection.set_metadata_hooks}, where the metadata hooks take priority *)
    val dispatch_iter_bin_prot_with_metadata
      :  ('query, 'response, 'error) t
      -> Connection.t
      -> 'query
      -> f:('response Pipe_message.t -> Pipe_response.t)
    ...
    (** [dispatch_iter_with_metadata] allows specifying the {!Rpc_metadata.V2.t} sent
        alongside this query.

        The [metadata] is merged with the metadata generated by the hooks from
        {!Connection.set_metadata_hooks}, where the metadata hooks take priority *)
    val dispatch_iter_with_metadata
      :  ('query, 'response, 'error) t
      -> Connection.t
      -> 'query
      -> f:(Bigstring.t -> pos:int -> len:int -> Pipe_response.t)
...
module State_rpc : sig
  ...
  module Expert : sig
    (** [dispatch_fold_bin_prot_with_metadata] is the same as the non-expert
        {!dispatch_fold}, except with metadata. It allows specifying the
        {!Rpc_metadata.V2.t} sent alongside this query.

        The [metadata] is merged with the metadata generated by the hooks from
        {!Connection.set_metadata_hooks}, where the metadata hooks take priority *)
    val dispatch_fold_bin_prot_with_metadata
      :  ('query, 'state, 'update, 'error) t
      -> Connection.t
      -> 'query
      -> init:('state -> 'acc)
